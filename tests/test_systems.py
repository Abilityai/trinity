...
class TestResilientDeploy:
    ...
    (#1759 note: an absent `local:` template now ALSO fails, with a 400
    `LOCAL_TEMPLATE_NOT_FOUND` raised even earlier — at template resolution,
    ...
    swapping it would change what this test covers.)
    """
