...
from routers.aauth import router as aauth_router  # ent#623 AAuth discovery documents (prototype, flag OFF)
...
app.include_router(aauth_router)  # AAuth /.well-known/aauth-* (ent#623, 404 unless the prototype flag is on)
