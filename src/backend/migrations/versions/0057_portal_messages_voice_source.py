...
Revision ID: 0057_portal_messages_voice_source
Revises: 0056_schedule_workspace_delivery
"""
from alembic import op


revision = "0057_portal_messages_voice_source"
down_revision = "0056_schedule_workspace_delivery"
branch_labels = None
depends_on = None
