...
CHECKS: List[CheckDef] = [
    ...
    _c("T-004", "hard", "static", "T", "resources.cpu is one the create path accepts, when declared"),
    _c("T-005", "hard", "static", "T", "resources.memory is one the create path accepts, when declared"),
