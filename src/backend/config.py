...
# exists this seed points at a 404 and `sync_library` reports a failed source
# (fail-soft by design — it never raises).
#
...
DEFAULT_SKILL_SOURCE_REF = os.getenv("TRINITY_DEFAULT_SKILL_SOURCE_REF", "v1.0.0")
