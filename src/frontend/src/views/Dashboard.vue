        ...
        <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-2">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2 flex-shrink-0">
              ...
              <!-- #1921: the standalone refresh spinner is REMOVED rather than
                   restyled. "First load animates; scheduled background refresh is
                   invisible" (design-system §6) — and this fired on every poll,
                   next to a Refresh button that already signals in-flight by
                   disabling itself, which is the sanctioned indicator. First load
                   is covered by this view's SkeletonLoader. -->
