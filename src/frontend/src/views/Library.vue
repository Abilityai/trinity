      ...
      <div class="px-4 sm:px-0">
        ...
        <div v-else>
          ...
          <div v-if="templates.length === 0 && !loading" class="text-center py-12">
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm">Add a GitHub repository under Settings → GitHub Templates, or add a template directory to <code>config/agent-templates/</code>.</p>
          </div>
        </div>
        </section>
