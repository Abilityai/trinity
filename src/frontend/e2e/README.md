...
| `agent-detail-talk-door` | `TALK_AGENT` | exists, **and on the signed-in operator's Workspace roster** (shared ∪ owned — an admin's reach on Agent Detail is wider than the roster's) |
