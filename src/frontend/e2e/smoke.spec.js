...
test.describe('smoke', () => {
  test('@smoke dashboard renders for authenticated admin', async ({ page }) => {
    await page.goto('/')
    // Top nav has Dashboard, Agents, Library, Operations, Settings (+ gated
    // Enterprise/Sessions). Health/Ops/Executions merged into Operations
    // (#1109); Templates renamed to Library (ent#263); Keys link removed in
    // #302 — MCP keys now live in Settings → MCP Keys tab.
