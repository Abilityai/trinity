...
- [v0.8.5](v0.8.5.md) — pre-release · Agents coordinate and report back: task-completion report-back, self-reminders, and shared rooms; resilient system deploy; full-directory skill packages; editable display names; personal GitHub tokens; retention safety; reliability & security hardening.
