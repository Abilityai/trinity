...
- [v0.9.5](v0.9.5.md) — 2026-09-17 · Workspace becomes where the work happens: chats per topic, a conversation rail, live execution cards, agent asks, a canvas for every agent, and real-time voice mode; prebuilt images and a one-click hosted install with browser-only first-run setup; subscription usage and headroom visibility; opt-in instance telemetry; credentials encrypted at rest and the GitHub token out of agents' git remotes.
