...
| `rooms.ts` (5) | `create_room`, `list_rooms`, `read_room`, `post_to_room`, `close_room` | Multi-agent rooms (ent#169; OSS core since ent#443) — see [Multi-Agent Rooms](#multi-agent-rooms-ent169-oss-core-since-ent443) |
