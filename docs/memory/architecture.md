...
classifies green→red transitions. No alert sink is wired in Phase 1
(stub at `_emit_transition` — Slack lands in the follow-up). No LLM
reasoning anywhere — the canary's value depends on determinism.
