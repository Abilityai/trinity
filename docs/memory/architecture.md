...
CREATE TABLE agent_loops (
    ...
    stop_reason TEXT,                            -- max_runs_reached | stop_signal_matched | user_stopped | deadline_exceeded | budget_exhausted | error | interrupted
    last_response TEXT,
    error TEXT,
