...
- **Property** (`tests/unit/test_1771b_timestamp_helpers_properties.py::test_P7_…`): validator-acceptance ⟹ parser-can-parse. Shipped by #1826 as a strict xfail documenting the divergence; #1831 makes it hold **by construction** and it now passes (~21% of draws accepted — a 0% share would mean a vacuous green).
