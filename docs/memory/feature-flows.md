...
| 2026-04-19 | #389 | Git sync health observability — auto-sync heartbeat, dual ahead/behind (P6 fix), `agent_sync_state` + `sync_failing` operator-queue, dashboard dot | [git-sync-health.md](feature-flows/git-sync-health.md) |
