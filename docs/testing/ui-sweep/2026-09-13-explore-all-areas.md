...
- `test-echo` access policy: `require_email` flipped false for the public send-flow sheet and **restored to true**. Public link `<token>` created and **revoked** (0 links left).
