...
| **J03** | I can create an agent with no configuration and get a useful answer. | user | local, digitalocean | journey-smoke | **no** | `tests/journeys/test_first_turn_journey.py` | E-05 | #2342 |
...
| **J12** | My agent's own declaration of what it measures is what Trinity actually knows about it. | user | local | live-stack | **no** | `tests/journeys/test_j12_declared_metrics_journey.py` | L-02, L-03 | #477 |
